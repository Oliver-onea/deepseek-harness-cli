...
import { classifyStartupFailure, loadLayeredEnv } from '@deepseek-ai/dsh-app-boot'
...
try {
  ...
  if (failure.kind === 'crash') throw failure.error
  writeSync(process.stderr.fd, `${failure.message}\n`)
  process.exit(1)
}
