...
flowchart LR
  ...
  plugin_dsh_base_command_credential["command-credential<br/>@deepseek-ai/dsh-command-credential"]
  cfg --> plugin_dsh_base_command_credential
...
| `command-credential` | `@deepseek-ai/dsh-command-credential` |
