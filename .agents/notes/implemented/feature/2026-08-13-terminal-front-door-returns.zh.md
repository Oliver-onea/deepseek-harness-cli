...
调色板按角色键控，并在部署所支持的最深色彩深度下绘制——真彩色、256 色、16 色 ANSI 集或无色彩——正文与背景保持终端默认值，因此宿主终端会为浅色与深色主题重映射界面，而无需 TUI 专属的主题设置（[色彩深度阶梯](../../proposed/architecture/2026-08-26-tui-color-depth-ladder.md)）。
