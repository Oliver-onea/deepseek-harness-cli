...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/ui/tui': { kind: 'indirect', reason: 'The /model command writes the model-selection ref this front door installs; prompt assembly snapshots the selection at the next assembly boundary and owns the model-visible request.' },
