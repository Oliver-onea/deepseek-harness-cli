...
- **Python SDK parity gap** — `interrupt` has no Python counterpart yet; the design twin gains it with its own change (see the protocol's [Known Limitations](../protocol/README.md)).
