...
- **Python SDK parity gap** — `steer` and `interrupt` have no Python counterpart yet; the design twin gains each with its own change (see the protocol's [Known Limitations](../protocol/README.md)).
