...
- **Python SDK parity gap** — only the TypeScript client calls `session/interrupt`; the Python design twin cannot interrupt yet and gains the method with its own change.
