...
- **Python SDK parity gap** — only the TypeScript client calls `session/steer` and `session/interrupt`; the Python design twin gains each method with its own change.
